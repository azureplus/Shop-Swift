...
#define kWRScreenHeight [UIScreen mainScreen].bounds.size.height

#define kIS_IPHONEXR         (kWRScreenWidth == 414.f  && kWRScreenHeight == 896.f  ? YES : NO)
#define kIS_IPHONEX          (kWRScreenWidth == 375.f  && kWRScreenHeight == 812.f  ? YES : NO)
#define kIS_IPHONE11         (kWRScreenWidth == 828.f  && kWRScreenHeight == 1792.f ? YES : NO)
#define kIS_IPHONE11Pro      (kWRScreenWidth == 1125.f && kWRScreenHeight == 2436.f ? YES : NO)
#define kIS_IPHONE11ProMax   (kWRScreenWidth == 1242.f && kWRScreenHeight == 2688.f ? YES : NO)
